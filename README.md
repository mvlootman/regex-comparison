...
| V (pcre)      |  7.66s| 0.2 (f7787ff)  | 1.147.334.656|1.300.987.904|35KB|compiled with -prod|
...
| V (pcre) AF     |  14.08s| 0.2 (f7787ff)  | 3.577.487.360|3.576.897.536|35KB|compiled with -prod -autofree|
